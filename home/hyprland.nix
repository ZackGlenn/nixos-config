...
bind = [
  ...
  "$mainMod CTRL, H, resizeactive, exact -10% 0%"
  "$mainMod CTRL, L, resizeactive, exact 10% 0%"
  "$mainMod CTRL, K, resizeactive, exact 0% 10%"
  "$mainMod CTRL, J, resizeactive, exact 0% -10%"
